      ...
      <div className="container mx-auto px-6 py-12">
        <div className="md:flex md:justify-between items-center text-center md:text-left">
          <div className="mb-8 md:mb-0">
            <h2 className="text-2xl font-bold font-playfair text-purple-400">AI Art & Sip</h2>
            <p className="text-gray-500 mt-2">Your virtual creative escape.</p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} AI Art & Sip. All rights reserved. Created with creativity.</p>
        </div>
      </div>
    </footer>
  );
